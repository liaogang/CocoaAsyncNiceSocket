...
@class GCDAsyncNiceSocketPreBuffer;
@protocol GCDAsyncNiceSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const GCDAsyncNiceSocketException;
extern NSString *const GCDAsyncNiceSocketErrorDomain;

extern NSString *const GCDAsyncNiceSocketQueueName;
extern NSString *const GCDAsyncNiceSocketThreadName;

extern NSString *const GCDAsyncNiceSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const GCDAsyncNiceSocketUseCFStreamForTLS;
#endif
#define GCDAsyncNiceSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define GCDAsyncNiceSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define GCDAsyncNiceSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const GCDAsyncNiceSocketSSLPeerID;
extern NSString *const GCDAsyncNiceSocketSSLProtocolVersionMin;
extern NSString *const GCDAsyncNiceSocketSSLProtocolVersionMax;
extern NSString *const GCDAsyncNiceSocketSSLSessionOptionFalseStart;
extern NSString *const GCDAsyncNiceSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const GCDAsyncNiceSocketSSLCipherSuites;
extern NSString *const GCDAsyncNiceSocketSSLALPN;
#if !TARGET_OS_IPHONE
extern NSString *const GCDAsyncNiceSocketSSLDiffieHellmanParameters;
#endif

#define GCDAsyncNiceSocketLoggingContext 65535


typedef NS_ERROR_ENUM(GCDAsyncNiceSocketErrorDomain, GCDAsyncNiceSocketError) {
	GCDAsyncNiceSocketNoError = 0,           // Never used
	GCDAsyncNiceSocketBadConfigError,        // Invalid configuration
	GCDAsyncNiceSocketBadParamError,         // Invalid parameter was passed
	GCDAsyncNiceSocketConnectTimeoutError,   // A connect operation timed out
	GCDAsyncNiceSocketReadTimeoutError,      // A read operation timed out
	GCDAsyncNiceSocketWriteTimeoutError,     // A write operation timed out
	GCDAsyncNiceSocketReadMaxedOutError,     // Reached set maxLength without completing
	GCDAsyncNiceSocketClosedError,           // The remote peer closed the connection
	GCDAsyncNiceSocketOtherError,            // Description provided in userInfo
};
...
//copied from <CocoaAsyncSocket>, only changed the class prefix namespace
@interface GCDAsyncNiceSocket : NSObject

/**
 * GCDAsyncNiceSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, GCDAsyncNiceSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<GCDAsyncNiceSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<GCDAsyncNiceSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create GCDAsyncNiceSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<GCDAsyncNiceSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<GCDAsyncNiceSocketDelegate> delegate;
...
- (void)getDelegate:(id<GCDAsyncNiceSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<GCDAsyncNiceSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<GCDAsyncNiceSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<GCDAsyncNiceSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means GCDAsyncNiceSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means GCDAsyncNiceSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, GCDAsyncNiceSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, GCDAsyncNiceSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of GCDAsyncNiceSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a GCDAsyncNiceSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a GCDAsyncNiceSocketReadMaxedOutError.
 ...
 * This is due to the fact that GCDAsyncNiceSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - GCDAsyncNiceSocketManuallyEvaluateTrust
 ...
 *     So GCDAsyncNiceSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - GCDAsyncNiceSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default GCDAsyncNiceSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct GCDAsyncNiceSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, GCDAsyncNiceSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by GCDAsyncNiceSocket,
 ...
 *
 * - GCDAsyncNiceSocketSSLProtocolVersionMin
 * - GCDAsyncNiceSocketSSLProtocolVersionMax
 ...
 * 
 * - GCDAsyncNiceSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - GCDAsyncNiceSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - GCDAsyncNiceSocketSSLCipherSuites
 ...
 *
 * - GCDAsyncNiceSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see GCDAsyncNiceSocketManuallyEvaluateTrust).
 ...
 *     You MUST use GCDAsyncNiceSocketSSLProtocolVersionMin & GCDAsyncNiceSocketSSLProtocolVersionMin instead.
...
/**
 * GCDAsyncNiceSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(GCDAsyncNiceSocket *)sock
 * {
...
@protocol GCDAsyncNiceSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(GCDAsyncNiceSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(GCDAsyncNiceSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (NSTimeInterval)socket:(GCDAsyncNiceSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(GCDAsyncNiceSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
 ...
 * 
 * Note: If the GCDAsyncNiceSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(GCDAsyncNiceSocket *)sock withError:(nullable NSError *)err;
 ...
 * - GCDAsyncNiceSocketManuallyEvaluateTrust == YES
 *
...
**/
- (void)socket:(GCDAsyncNiceSocket *)sock didReceiveTrust:(SecTrustRef)trust
