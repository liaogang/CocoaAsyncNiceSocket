...
Updated and maintained by Deusty LLC and the Apple development community.
  ...
  s.source   = { :git => 'https://github.com/robbiehanson/CocoaAsyncNiceSocket.git',
                 :tag => "#{s.version}" }

  s.description = 'CocoaAsyncNiceSocket supports TCP and UDP. The AsyncSocket class is for TCP, and the AsyncUdpSocket class is for UDP. ' \
